...
img  {
	...
	background-image: url(images/dokuwiki-128.png);
}
...
<body style="background-color: #eee;">
  Images with background-color, background-image, border, margin and padding
  <img src="images/php.gif" />
  <img src="images/dompdf_simple.png" />
  <img src="images/dompdf_simple.png" style="background-repeat: no-repeat;" />
  <img src="images/php.gif" style="background-repeat: no-repeat;" />
