...
class Dompdf
{
    ...
    */
     ...
     *
     * 'Accept-Ranges' => 1 or 0 (=default): Send an 'Accept-Ranges:' HTTP header, according to 
     *    https://tools.ietf.org/html/rfc2616#section-14.5
     *    This header seems to have caused some problems, despite the fact that it is supposed
     *    to solve them, so I am leaving it off by default.
     *
     * 'compress' = > 1 (=default) or 0: Apply content stream compression
     *
     * 'Attachment' => 1 (=default) or 0: Set the 'Content-Disposition:' HTTP header to 'attachment'
